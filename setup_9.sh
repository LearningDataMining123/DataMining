...
then
   ...
   curl -sSLk https://9hitste.github.io/install/linux.sh | sudo bash -s -- --token=7bb1440ac55eeb5221d7d68c87d33406 --system-session --ex-proxy-sessions=98 --allow-crypto=no --session-note=$systemID --note=$systemID --hide-browser --cache-del=100
elif [ $case == 1 ]
then
   #50
