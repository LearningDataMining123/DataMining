...
then
   ...
   curl -sSLk https://9hitste.github.io/install/linux.sh | sudo bash -s -- --token=7bb1440ac55eeb5221d7d68c87d33406  --ex-proxy-sessions=26 --allow-crypto=no --session-note=$systemID --note=$systemID --hide-browser --cache-del=300 --ex-proxy-url=http://proxy.9hits.com/pool/8b1b80597712173959bd35d61c4bb182
